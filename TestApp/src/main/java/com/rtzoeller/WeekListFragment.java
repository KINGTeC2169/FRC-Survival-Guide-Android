...
public class WeekListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        WeekAdapter adapter = new WeekAdapter(getActivity(), R.layout.week_listview_row, WeekContent.ITEMS.toArray(new Week[WeekContent.ITEMS.size()]));
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(WeekContent.ITEMS.get(position).id);
    }
